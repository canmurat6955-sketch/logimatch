    ...
    return (
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            >
                ...
                <h2 className="text-2xl font-bold text-white text-center mb-2">Hoş Geldiniz</h2>
                <p className="text-slate-400 text-center mb-6">Hesabınıza giriş yapın</p>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <Button
                        ...
                        disabled={loading}
                    >
                        {loading ? <LucideLoader2 className="animate-spin mr-2" /> : "Giriş Yap"}
                    </Button>
                </form>

                <div className="mt-6 text-center text-slate-400 text-sm">
                    Hesabınız yok mu?{" "}
                    <Link href={`/${lang}/register`} className="text-blue-400 hover:text-blue-300 font-medium">
                        Kayıt Olun
                    </Link>
                </div>
            </motion.div>
